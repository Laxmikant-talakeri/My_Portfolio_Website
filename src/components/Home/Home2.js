      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            Hello! I'm Laxmikant, a passionate and creative frontend developer based in Bengaluru. I have a strong love for coding and a genuine enthusiasm for crafting beautiful and functional web experiences. <br/>
              <br />
              My journey into the world of web development I began by exploring the basics of HTML and CSS, learning how to structure web content and style it to create visually appealing layouts. As I delved deeper into the world of web development, I realized that there was so much more to learn. I started to explore JavaScript to add interactivity and functionality to my web projects.. Since then, I've been on an exciting learning adventure, keeping up with the latest technologies and design trends to create engaging and responsive websites.<br/>
              <br />I am fluent in classics like <br/>
              <i>
                <b className="purple"> 
                 **Languages:** Java, Python , C++ ,  HTML5, CSS3, JavaScript (ES6+) <br/>

                **Frameworks/Libraries:** React.js, Bootstrap, jQuery <br/>
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/Laxmikant-talakeri"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/laxmikant-t-409533221/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/laxmikant_talakeri"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
